...
contains RNA-Seq counts for healthy individuals and COVID-19 patients.

The data set has been already processed and downloaded; however, below you
will find the code to replicate this procedure.
...
#| fig.width=12,
#| fig.height=12
g1 <- ggEvidencePlot(gl, m = "DC.M1.2") + ggtitle("AUC 0.99")
g2 <- ggEvidencePlot(gl, m = "LI.M68") + ggtitle("AUC 0.93")
g3 <- ggEvidencePlot(gl, m = "LI.M165") + ggtitle("AUC 0.76")
g4 <- ggEvidencePlot(gl, m = "LI.M4.0") + ggtitle("AUC 0.61")
